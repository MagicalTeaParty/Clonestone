...
{   
    ...
    [SyncVar]
    public float syncRotY; //Y-Rotation der Karte zum Synchronisieren

    [SyncVar]
    public float syncRotX; //X-Rotation
    ...
    void Update()
    {
        ...
        if(Input.GetKeyDown(KeyCode.R))
        {
            ...
            if(hasAuthority)
            {
                ...
                if(this.transform.rotation.eulerAngles.x == 90f)
                    TransmitFlipSync(270);
                else
                    TransmitFlipSync(90);
            }
        }
    ...
    void RemotePositionSync()
    {
        ...
        this.transform.rotation = Quaternion.Euler(syncRotX,syncRotY, 0);
